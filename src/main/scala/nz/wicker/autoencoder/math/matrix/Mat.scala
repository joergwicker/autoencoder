...
class Mat protected (
  ...
  def shuffleRows(): Unit = permutateRows(
    nz.wicker.autoencoder.math.random.permutation(height)
  )
  ...
  override def toImage(colormap: Double => Int) = {
    nz.wicker.autoencoder.visualization.draw(this, colormap)
  }
  
  def toImage = {
    nz.wicker.autoencoder.visualization.draw(this)
  }
}
...
object Mat {
  ...
  */
  ...
  def main(args: Array[String]) {
    ...
    val permutation = nz.wicker.autoencoder.math.random.permutation(size)
